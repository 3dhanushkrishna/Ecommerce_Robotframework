...
#    Choose File  name:image  C:/Users/ELCOT/PycharmProjects/Ecommerce-Application-Project/static/ui/oneplus.jpg
#    sleep  2s
...
#    sleep  1s
#    Execute Javascript  window.scrollTo(0,700)
#    Click Button  Xpath:/html/body/div/div/a/button
#    sleep  1s
#    Close Browser
#
...
Test Product name
    Input Text  name:name  Mi mobile
Test Product price
...
Test Delete Product
    Input Text  name:name  Mi mobile
Test Search Product
    Input Text  name:sea  OnePlus Nord CE2 5G
